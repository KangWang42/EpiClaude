...
>本节来介绍一个可视化案例，将常见的饼图通过矩形的方式来进行比例的展示，有合适的数据可以尝试此案例。**数据+代码已经上传2023VIP群，加群的观众老爷请自行下载**
...
![](https://files.mdnice.com/user/7338/5aa3e4db-6af6-4ae8-a301-2a27621d4b61.png)
